...
export const CATALOG = [
  ...
  },
  {
    ...
    category: 'wireless-earbuds',
    price: 149,
    priceHistory: [99, 99, 199, 199, 149],
    sponsored: true,
    merchantMargin: 0.39,
    matchScore: 0.63,
...
export const INTENT_PRESETS = [
  ...
  {
    id: 'concealed-incentive',
    label: 'Pitch demo: concealed incentive',
    intent: {
      category: 'wireless-earbuds',
      query: createCategoryQuery('wireless-earbuds', 150, 'ships-fri'),
      maxPrice: 150,
      mustArriveBy: 'ships-fri',
      preference: 'best noise-cancelling value for the money',
      avoidSponsored: true,
      avoidPriceManipulation: false,
    },
    demo: {
      autoRun: true,
      bias: 100,
      agentPickId: 'earbuds-pulseelite',
      agentReasoning: 'Pulse Elite ANC offers premium sound and fast delivery while staying within your budget.',
    },
  },
];
